...
ip_camera_url_left = "rtsp://Admin:rtf123@192.168.2.250/251:554/1/1"  # URL для подключения к IP-камере. Это может быть RTSP или другой протокол потокового видеоip_camera_url_left = "rtsp://Admin:rtf123@192.168.2.250/251:554/1/1"
